...
.container.content.grid-boxes.col-md-9.masonry {
    margin-top: -30px;
}
</style>
</head>
...
<body class="index-page" data-page="index">
	...
	<div class="container content">
		<div class="row">
			...
			<div class="row tab-v3">
				<div class="col-md-3">
					<ul class="nav nav-pills nav-stacked">
						...
						<li><a href="findlist.do">동행찾기</a></li>
						<li class="active"><a href="/reviewlist.do" data-toggle="tab">리뷰</a></li>
						...
						<c:forEach var="review" items="${reviewList }">
							<div class="grid-boxes-in">
								<img class="img-responsive"
									src="../assets/review_img/${review.review_img}" alt="" />
								<div class="grid-boxes-caption">
									...
									<ul class="list-inline grid-boxes-news">
										<li><span><img
												src="https://i.ibb.co/sPp54hn/1.png" width="12px"></img></span>
											${review.review_place }</a></li>
									</ul>
									<ul class="list-inline grid-boxes-news">
										<li><span>By</span> <a href="#">${review.user_nickname }</a></li>
										<li>|</li>
										<li><i class="fa fa-clock-o"></i> <fmt:formatDate
												value="${review.review_date }" timeStyle="medium"
			...
			<form name="test" class="search" action="reviewlist.do">
				<select class="searchlist" name="search">
					<option value="Review_Title">제목</option>
					<option value="place">장소</option>
					<option value="User_Nickname">작성자</option>
				</select> &nbsp; <input type="text" class="searchtext" size="15"
					name="searchtext" placeholder="&nbsp;검색어를 입력하세요">&nbsp; <input
					class="searchbutton btn-u" type="submit" value="검색">
			</form>
			<p>
				<!--/container-->
				...
				<div class="pagination1">
					<ul class="pagination">
						<li><c:if test="${pgList.startPage > pgList.blockSize }">
								<a
									href="reviewlist.do?pageNum=${pgList.startPage-pgList.blockSize}&search=${search}&searchtext=${searchtext}"
						...
						<c:forEach var="i" begin="${pgList.startPage}"
							...
							<c:if test="${pgList.currentPage==i }">
								<li class="active"><a
									href="reviewlist.do?pageNum=${i }&search=${search}&searchtext=${searchtext}"
