...
<body>
	...
	<div class="wrapper">
		...
		<div class="container">
			...
			<div class="col-md-9 findlist">
				...
				<!-- General Unify Forms -->
				<form method="post" action="findUpdatePro.do?company_no=${company.company_no}" class="sky-form">
				
					<!-- 동행구하기 글 제목 -->
					<fieldset>
						<section>
							<label class="label">제목</label>
							<label class="input"> <input type="text" name="company_title" id="company_title" value="${company.company_title}"/></label> 
						</section>
					</fieldset>
					...
					<fieldset>
						...
						<div class="row">
							<section class="col col-6"> <label class="input">
								...
								<input type="text" name="company_startdate" id="start" placeholder="여행 시작일" value="${company.company_startdate}" />
							</section>
							<section class="col col-6"> <label class="input">
								<i class="icon-append fa fa-calendar"></i> 
								<input type="text" name="company_enddate" id="finish" placeholder="여행 종료일" value="${company.company_enddate}"/>
							</section>
						</div>
						</section>
					</fieldset>
					...
					<fieldset>
						<section> 
							...
							<label class="textarea">
								<textarea rows="5" name="company_content" id="company_content">${company.company_content }</textarea>
							</label>
							<div class="note"></div>
						</section>
					</fieldset>
					...
					<footer>
						...
						<button type="button" class="btn-u btn-u-default" onclick="history.back();">취소</button>
					</footer>
				</form>
				</center>
	...
	<script type="text/javascript">
        ...
        $(document).ready(function() {
			$("input[name='company_theme'][value='${company.company_theme }']").attr("checked", true);
			$("input[name='company_gender'][value='${company.company_gender }']").attr("checked", true);
