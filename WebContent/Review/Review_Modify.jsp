				...
				<form action="#" class="sky-form">
					<fieldset>
						<section> 
							...
							<label class="input"> <input type="text" value="새별오름"></label> 
						</section>
						<section> 
							...
							<label for="file" class="input input-file">
								...
								<input type="text" value="img/jeju1.png" readonly>
							</label> 
						</section>
					</fieldset>
					...
					<fieldset>
						...
						<label class="textarea">
							<textarea rows="10">제주도의 가을 새별오름의 억새밭을 거닐며 바람과 함께 사삭사삭거리는 억새들의 소리를 들으니 자연과 함께 마음이 평온해지고 정말 오랜만에 힐링을 느낄 수 있었습니다. 제주도의 가을은 점점 더 멋있어 지는 것 같습니다!
							</textarea>
						</label>
						<div class="note"></div>
						</section>
